...
class JList(list):
    ...
    def __init__(self, data: JArray | None = None, *, chainable: bool = False) -> None:
        """Create a new type-safe list helper."""
        self._data = data or {}
    ...
    def expect[T](self, key: int | str, type_: type[T]) -> T:
        ...
        Raises:
            ...
            TypeError: if the list is indexed with a string (e.g. when chaining)
            ValueError: if a string key or path is specified, but chaining is
                disabled.
